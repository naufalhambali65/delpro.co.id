...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $styles = Style::all();
        $cities = City::all();
        return view('admin.projects.index', compact('title', 'projects', 'types', 'styles', 'cities'));
    }
    ...
    public function create()
    {
        ...
        $types = Type::all();
        $cities = City::all();
        return view('admin.projects.create', compact('title', 'styles', 'types', 'cities'));
    }
    ...
    public function show(Project $project)
    {
        ...
        return view('admin.projects.show', compact('title', 'project', 'images'));
    }
    ...
    public function edit(Project $project)
    {
        ...
        return view('admin.projects.edit', compact('title', 'project', 'styles', 'types', 'cities', 'pondFiles'));
    }
