                ...
                <form method="post" action="{{ route('teams.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-header d-flex align-items-center">
                        <h2 class="card-title mb-0 fw-bold">
                            <i class="fas fa-plus me-2 text-primary"></i> New Team
                        </h2>
                        <div class="ms-auto">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('photo') is-invalid @enderror" type="file"
                                        id="photo" name="photo" onchange="previewImage()" value="{{ old('photo') }}">
                                    @error('photo')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('facebook') is-invalid @enderror"
                                        id="facebook" name="facebook" autofocus value="{{ old('facebook') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('twitter') is-invalid @enderror"
                                        id="twitter" name="twitter" autofocus value="{{ old('twitter') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('linkedin') is-invalid @enderror"
                                        id="linkedin" name="linkedin" autofocus value="{{ old('linkedin') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('instagram') is-invalid @enderror"
                                        id="instagram" name="instagram" autofocus value="{{ old('instagram') }}"
