                ...
                <form method="post" action="{{ route('projects.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-header d-flex align-items-center">
                        <h2 class="card-title mb-0 fw-bold">
                            <i class="fas fa-plus me-2 text-primary"></i> New Project
                        </h2>
                        <div class="ms-auto">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="visibility" name="visibility" required>
                                        <option value="private" @selected(old('visibility') == 'private') selected>
                                            Private
                                        </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="style_id" name="style_id" required>
                                        ...
                                        @foreach ($styles as $style)
                                            <option value="{{ $style->id }}" @selected(old('style_id') == $style->id)>
                                                {{ $style->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('material') is-invalid @enderror"
                                        id="material" name="material" required autofocus value="{{ old('material') }}">
                                    @error('material')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="job_status" name="job_status" required>
                                                <option value="" disabled @selected(old('job_status') == '') hidden>--
                                                    Select Job Status
                                                    --
                                                </option>
                                                <option value="waiting" @selected(old('job_status') == 'waiting')>
                                                    Waiting
                                                </option>
                                                <option value="in_progress" @selected(old('job_status') == 'in_progress')>
                                                    In Progress
                                                </option>
                                                <option value="in_review" @selected(old('job_status') == 'in_review')>
                                                    In Review
                                                </option>
                                                <option value="done" @selected(old('job_status') == 'done')>
                                                    Done
                                                </option>
                                                <option value="cancelled" @selected(old('job_status') == 'cancelled')>
                                                    Cancelled
                                                </option>
                                                <option value="rejected" @selected(old('job_status') == 'rejected')>
                                                    Rejected
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="worker" type="hidden" name="worker" value="{{ old('worker') }}">
